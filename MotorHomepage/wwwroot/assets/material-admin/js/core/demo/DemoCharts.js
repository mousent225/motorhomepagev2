		...
		chart.bind("plothover", function (event, pos, item) {
			if (item) {
				if (previousPoint !== item.dataIndex) {
					...
					var tipContent = y + " " + item.series.label.toLowerCase() + " on " + moment(x).format('MMMM');
	...
	p._initMorris = function () {
		...
		if ($('#morris-bar-graph').length > 0) {
			Morris.Bar({
				...
				data: [
					{Day: '01/12', Visitor: 33, Vehicle: 32, Container: 3},
					{Day: '2/12', Visitor: 2, Vehicle: 44, Container: 1},
					{Day: '3/12', Visitor: 10, Vehicle: 22, Container: 24},
					{Day: '4/12', Visitor: 22, Vehicle: 24, Container: 3},
					{Day: '5/12', Visitor: 32, Vehicle: 11, Container: 1},
					{Day: '6/12', Visitor: 20, Vehicle: 12, Container: 14},
					{Day: '7/12', Visitor: 2232, Vehicle: 4, Container: 3},
					{Day: '8/12', Visitor: 42, Vehicle: 22, Container: 1},
					{Day: '9/12', Visitor: 2250, Vehicle: 222, Container: 34},
					{Day: '10/12', Visitor: 62, Vehicle: 14, Container: 3},
					{Day: '11/12', Visitor: 2, Vehicle: 33, Container: 1},
					{Day: '12/12', Visitor: 0, Vehicle: 2, Container: 24},
					{Day: '13/12', Visitor: 2, Vehicle: 24, Container: 3},
					{Day: '14/12', Visitor: 2, Vehicle: 12, Container: 1},
					{Day: '15/12', Visitor: 0, Vehicle: 23, Container: 34},
					{Day: '16/12', Visitor: 2, Vehicle: 44, Container: 3},
					{Day: '17/12', Visitor: 2, Vehicle: 121, Container: 1},
					{Day: '18/12', Visitor: 0, Vehicle: 62, Container: 34},
					{Day: '19/12', Visitor: 2, Vehicle: 64, Container: 3},
					{Day: '20/12', Visitor: 2, Vehicle: 31, Container: 1},
					{Day: '21/12', Visitor: 10, Vehicle: 52, Container: 34},
					{Day: '22/12', Visitor: 12, Vehicle: 44, Container: 3},
					{Day: '23/12', Visitor: 22, Vehicle: 122, Container: 1},
					{Day: '24/12', Visitor: 30, Vehicle: 2, Container: 24},
					{Day: '25/12', Visitor: 42, Vehicle: 4, Container: 3},
					{Day: '26/12', Visitor: 52, Vehicle: 112, Container: 1},
					{Day: '27/12', Visitor: 10, Vehicle: 22, Container: 124},
					{Day: '28/12', Visitor: 32, Vehicle: 34, Container: 3},
					{Day: '29/12', Visitor: 42, Vehicle: 333, Container: 1},
					{Day: '30/12', Visitor: 50, Vehicle: 2, Container: 24},
					{Day: '31/12', Visitor: 22, Vehicle: 4, Container: 3}
				],
				xkey: 'Day',
				ykeys: ['Visitor', 'Vehicle', 'Container'],
				labels: ['Visitor', 'Vehicle', 'Container'],
